...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--bert_name", type=str, default="bert-base-uncased", help="name of bert model")
    parser.add_argument("--domains", type=str, nargs="+", default=["w", "v", "n"], help="domains to include")
